...
import se.ade.mc.cubematic.crafting.isCraftingDropper
import se.ade.mc.cubematic.crafting.setCraftingDropper
...
class ChannelingDropperAspect(private val plugin: se.ade.mc.cubematic.CubematicPlugin): Listener {
    @EventHandler
